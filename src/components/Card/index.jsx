...
function Card({topic,domains, technologies, description}) {
  return (
        <div class="flex flex-col min-w-52 p-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 items-center ">
            <a href="#">
                <h5 class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">{topic}</h5>
            </a>
